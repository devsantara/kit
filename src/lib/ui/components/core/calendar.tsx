...
import { Button, buttonVariants } from '~/lib/ui/components/core/button';
    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === 'left') {
            return (
              <Icons.CalendarPrevious className={cn('size-4', className)} {...props} />
            );
          }
          ...
          return (
            <Icons.CalendarDropdown className={cn('size-4', className)} {...props} />
          );
        },
